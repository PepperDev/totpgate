...
static void test_rfc2202_1(void)
{
    ...
    hex_to_bytes("b617318655057264e28bc0b6fb378c8ef146be00",
                 expected, HMAC_SHA1_LEN);
...
static void test_rfc2202_2(void)
{
    ...
    const unsigned char *data =
        (const unsigned char *)"what do ya want for nothing?";
...
static void test_rfc2202_3(void)
{
    ...
    hex_to_bytes("125d7342b9ac11cd91a39af48aa17b4f63f175d3",
                 expected, HMAC_SHA1_LEN);
...
static void test_rfc2202_4(void)
{
    ...
    hex_to_bytes("4c9007f4026250c6bc8414f9bf50c86c2d7235da",
                 expected, HMAC_SHA1_LEN);
    hmac_sha1(key, sizeof(key), data, sizeof(data), out);
    ASSERT_TRUE(check(out, expected) == 0);
}
...
static void test_rfc2202_5(void)
{
    ...
    unsigned char expected[HMAC_SHA1_LEN];
    const unsigned char *data =
        (const unsigned char *)"Test With Truncation";

    fill_byte(key, sizeof(key), 0x0c);
    hex_to_bytes("4c1a03424b55e07fe7f27be1d58bb9324a9a5a04",
                 expected, HMAC_SHA1_LEN);
...
static void test_rfc2202_6(void)
{
    ...
    fill_byte(key, sizeof(key), 0xaa);
    hex_to_bytes("aa4ae5e15272d00e95705637ce8a3b55ed402112",
                 expected, HMAC_SHA1_LEN);
...
static void test_rfc2202_7(void)
{
    ...
    fill_byte(key, sizeof(key), 0xaa);
    hex_to_bytes("e8e99d0f45237d786d6bbaa7965c7808bbff1a91",
                 expected, HMAC_SHA1_LEN);
